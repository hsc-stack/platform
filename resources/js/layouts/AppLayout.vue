...
<template>
    ...
    >
        ...
        >
            <div
                class="absolute -top-[30%] left-1/2 -translate-x-1/2 h-[900px] w-[1200px] rounded-full bg-[radial-gradient(ellipse_at_center,rgba(99,102,241,0.18)_0%,rgba(165,180,252,0.05)_50%,transparent_70%)] blur-[120px]"
            ></div>
